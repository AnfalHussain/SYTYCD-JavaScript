...
function getBookById(bookId, booksArray) {
  ...
  var mybook =  booksArray.find(book => book.id === bookId);
  if (mybook === undefined){
        return undefined
...
function getAuthorByName(authorName, authors) {
  ...
  let result=  authors.find(author => (author.name).toLowerCase() === authorName.toLowerCase())
  return result

  // var myAuthor = authors.find(
  //   author => author.name.toLowercase() === authorName.toLowercase()
  // );

  // if (myAuthor === undefined)
  // {
  //   return undefined
